...
export const translations = {
  ru: {
    ...
    auth: {
      regTitle: 'Регистрация пользователя',
      loginTitle: 'Вход в систему',
      firstNameLabel: 'Имя *',
      lastNameLabel: 'Фамилия *',
      phoneLabel: 'Номер телефона *',
      passwordLabel: 'Пароль *',
      btnRegister: 'Зарегистрироваться и продолжить',
      btnLogin: 'Войти',
      btnCancel: 'Отмена',
      logout: 'Выйти',
  ...
  en: {
    ...
    auth: {
      ...
      btnRegister: 'Register and Continue',
      btnLogin: 'Log In',
      btnCancel: 'Cancel',
      logout: 'Log Out',
