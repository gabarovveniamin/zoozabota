  ...
  ru: {
    ...
    home: {
      ...
      stats: [
        ...
        { number: '∞', label: 'Памятей навсегда' },
        { number: '❤️', label: 'С любовью к животным' },
      ],
  ...
  kz: {
    ...
    home: {
      ...
      stats: [
        ...
        { number: '∞', label: 'Мәңгілік естеліктер' },
        { number: '❤️', label: 'Жануарларға деген сүйіспеншілікпен' },
      ],
  ...
  en: {
    ...
    home: {
      ...
      stats: [
        ...
        { number: '∞', label: 'Memories Forever' },
        { number: '❤️', label: 'With Love for Animals' },
      ],
